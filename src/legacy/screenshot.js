/**
 * This is a quick backport of the screenshot feature in the new Vue client. When migration is complete this file will be redundant.
 */

 /**
  * Generate a screenshot and asynchronously return a URL which can be used to display/download it
  * @param {Number} resX Width, in pixels, of screenshot to capture
  * @param {*} resY Height, in pixels, of screenshot to capture
  * @param {Number} bgColor Desired background colour (hex literal)
  * @param {Number} bgAlpha Desired background opacity (float 0-1, where 0 is fully transparent and 1 is fully opaque)
  * @returns {Promise<string>}
  */
module.exports = function screenshot(resX, resY, bgColor, bgAlpha) {
	...
	renderer.setRenderTarget(screenshotTarget); // doesn't work in this version of three.js?

	// render to texture and extract pixel data
	renderer.clear(true, true, true);
	// renderer.render(scene, camera);
	renderer.render(scene, camera, screenshotTarget); // target must be specified here in this version of three.js?
