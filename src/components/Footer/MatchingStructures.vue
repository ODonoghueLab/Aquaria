...
<style>
 /* #vis {
  ...
  div.panel span.help {
    ...
    width: 17px;
    height: 17px;
    background: url(../../assets/img/UI-help.png) no-repeat 0px 0px;
    margin-left: 8px;
  }
...
*/
  ...
  div.popup {
    background: url(../../assets/img/point.png) no-repeat center bottom;
    display: none;
    padding: 0 0 14px 0;
    position: absolute;
    width: 320px;
  ...
  span.x {
    background: url(../../assets/img/UI-close.png) no-repeat;
    display: block;
    float: right;
    height: 18px;
    width: 18px;
