...
$('#threeD').on('resize', function () {
  // disable redraw if cluster is expanded or help is visible
  if ($('div.dimmer').length == 1 || $('.chardinjs-overlay').length == 1) { /* console.log("resize event fired by cluster expansion"); */ } else {
...
function expandFullScreen () {
  ...
  $('span#expander, div.panel#structure-viewer').toggleClass('fullscreen')
...
module.exports.stopLogoSpin = function stopLogoSpin () {
	 $('#wait').hide()
}

module.exports.startLogoSpin = function startLogoSpin () {
	 $('#wait').show()
}
...
$(function () {
  ...
  $('body').on('chardinJs:stop', function () {
    console.log('closed help - redrawing')
