...
// customized by Christian Stolte for Aquaria
(function () {
  var __slice = [].slice;
  ...
  (function ($, window) {
    ...
    chardinJs = (function () {
      ...
      chardinJs.prototype.start = function () {
        ...
        if (this._overlay_visible()) {
          return false
  	  	...
  	  	$('body, #gallery').css('margin-top', '5em') // set new UI top margin
      ...
      chardinJs.prototype.stop = function () {
    	  $('body, #gallery').css('margin-top', '0') // reset UI top margin
      ...
      chardinJs.prototype._add_overlay_layer = function () {
        var element_position; var overlay_layer; var styleText
        var _this = this
      ...
      chardinJs.prototype._position_helper_layer = function (element) {
        ...
        helper_layer = $(element).data('helper_layer') // console.log(helper_layer);
        element_position = this._get_offset(element) // console.log("element_position = "+element_position.top+", "+element_position.left)
      ...
      chardinJs.prototype._get_offset = function (element) {
        ...
        element_position = {
          width: element.offsetWidth, // $(element).outerWidth(), //
          height: element.offsetHeight // $(element).outerHeight() //
        }
        _x = 0
        _y = 0
        while (element && !isNaN(element.offsetLeft) && !isNaN(element.offsetTop)) {
          _x += element.offsetLeft // $(element).offset().left;	//
          _y += element.offsetTop // $(element).offset().top;	//
          element = element.offsetParent // $(element).offsetParent();	//
