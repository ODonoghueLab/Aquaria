<template>
    <div id="about_matrix">
        ...
        <div id="content">
            ...
            <div>
            <p>This page summarizes all available 3D structural information for all proteins comprising the COVID-19
              <a v-bind:href="redirect(this.synonymsArray[0])" target="_blank"> {{ OrganismName }} </a>
              virus (SARS-CoV-2).
              <!-- (a.k.a. {{ this.synonymsString }} ). -->
            </p>
            <p>
            The page gives access to 872 structural models generated by finding all sequence regions with detectable similarity to any currently published 3D structure (<a target='_blank' href="https://doi.org/10.1101/2020.07.16.207308">O'Donoghue et al., bioRxiv 2020</a>).
            ...
            <p id='teams'>
              <i>
              The Aquaria-COVID resource is hosted by the <a target='_blank' href="https://www.garvan.org.au/">Garvan Institute of Medical Research</a> (Sydney, Australia), and is maintained in collaboration with <a target='_blank' href="https://data61.csiro.au/">CSIRO Data61</a> (
              Sydney, Australia), the <a target='_blank' href="https://www.unsw.edu.au/"> UNSW</a> (Sydney, Australia), the <a target='_blank' href="https://www.hswt.de/en.html">
