<template>
    <div id="about_matrix">
        ...
        <div id="content">            <!-- if content visible, help mouseover disable -->
            ...
            <p>This page summarizes currently available 3D structural information for all proteins believed to comprise {{ OrganismName }} (also known as {{ OrgSynonyms }}).</p>
