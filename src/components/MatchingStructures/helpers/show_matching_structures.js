...
var CoverageMapRenderer = require('./coverageMap')
var d3 = require('d3')
...
ShowMatchingStructures.prototype.drawCoverageMap = function (cluster) {
  ...
  // document.querySelectorAll("#selectedCluster [id*='c_'] rect.cluster").forEach(function (part) {
  ...
  document.querySelectorAll("#selectedCluster [id*='c_'] .residue rect").forEach(function (part) {
    part.style.fill = '#a5a5a5'
    part.style.stroke = '#a5a5a5'
